...
const AgregarNoticia = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (validarTituloNoticia(tituloNoticia) &&
        ...
        <Container>
            ...
            <Form className="my-5" onSubmit={handleSubmit}>
                <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" placeholder="El dolar se volvio a disparar" onChange={(e) => setTituloNoticia(e.target.value)} />
                </Form.Group>
                <Form.Group className="mb-3">
                    <Form.Label>Descripcion*</Form.Label>
                    <Form.Control type="text" placeholder="Una vez mas, el dolar volvio a superar la barrera de los..." onChange={(e) => setDescripcionNoticia(e.target.value)} />
                </Form.Group>
                <Form.Group className="mb-3">
                    <Form.Label>Url que contiene la imagen de la noticia*</Form.Label>
                    <Form.Control type="text" placeholder="https://image.shutterstock.com/z/stock-photo-one-hundred-dollars-dinero-money-dolars-cash-flow-1446368390.jpg" onChange={(e) => setUrlNoticia(e.target.value)} />
                </Form.Group>
                <Form.Group className="mb-3">
